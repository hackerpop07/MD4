                    ...
                    <ol class="commentlist">
                        ...
                        <li class="depth-1 comment">
                            ...
                            <div class="comment__avatar">
                                <img class="avatar" src="storage/wordsmith/images/avatars/user-01.jpg" alt="" width="50"
                                     height="50">
                            </div>
                        ...
                        <li class="thread-alt depth-1 comment">
                            ...
                            <div class="comment__avatar">
                                <img class="avatar" src="storage/wordsmith/images/avatars/user-04.jpg" alt="" width="50"
                                     height="50">
                            </div>
                            ...
                            <ul class="children">
                                ...
                                <li class="depth-2 comment">
                                    ...
                                    <div class="comment__avatar">
                                        <img class="avatar" src="storage/wordsmith/images/avatars/user-03.jpg" alt=""
                                             width="50" height="50">
                                    </div>
                                    ...
                                    <ul class="children">
                                        ...
                                        <li class="depth-3 comment">
                                            ...
                                            <div class="comment__avatar">
                                                <img class="avatar" src="storage/wordsmith/images/avatars/user-04.jpg"
                        ...
                        <li class="depth-1 comment">
                            ...
                            <div class="comment__avatar">
                                <img class="avatar" src="storage/wordsmith/images/avatars/user-02.jpg" alt="" width="50"
                                     height="50">
                            </div>
